...
export const languageSkillDatas: Skill[] = [
  {
    name: 'HTML',
  ...
  {
    name: 'Golang',
    icon: 'https://cdn.worldvectorlogo.com/logos/go-8.svg',
  },
];

export const frameworkOrLibrarySkillDatas: Skill[] = [
  {
    name: 'Bootstrap',
  ...
  {
    name: 'Vue.js',
    icon: 'https://cdn.iconscout.com/icon/free/png-256/free-vue-282497.png?f=webp',
  },
  {
    name: 'React.js',
  ...
  {
    name: 'Chakra UI',
    icon: 'https://img.icons8.com/color/480/chakra-ui.png',
  },
  {
    name: 'Gin',
  ...
  {
    name: 'Hapi.js',
    icon: 'https://raw.githubusercontent.com/hapijs/assets/master/images/hapi.png',
  },
  {
    name: 'Joi',
    icon: 'https://joi.dev/_nuxt/img/joiTransparent.c5fc726.png',
  },
  {
    name: 'Gorm',
...
export const toolSkillDatas: Skill[] = [
  ...
  {
    name: 'GitHub',
    icon: 'https://cdn.icon-icons.com/icons2/3685/PNG/512/github_logo_icon_229278.png',
  },
  {
    name: 'Node.js',
  ...
  {
    name: 'RabbitMQ',
    icon: 'https://cdn.icon-icons.com/icons2/2699/PNG/512/rabbitmq_logo_icon_170810.png',
  },
];

export const databaseSkillDatas: Skill[] = [
  {
    name: 'MySQL',
    icon: 'https://cdn.icon-icons.com/icons2/2107/PNG/512/file_type_mysql_icon_130379.png',
  },
  {
    name: 'PostgreSQL',
    icon: 'https://cdn.icon-icons.com/icons2/2415/PNG/512/postgresql_original_logo_icon_146391.png',
  },
  {
    name: 'Redis',
    icon: 'https://cdn.icon-icons.com/icons2/2415/PNG/512/redis_original_logo_icon_146368.png',
  },
];
