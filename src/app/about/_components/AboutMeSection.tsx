...
const AboutMeHeader = () => {
  return (
    <header className="mb-7 flex items-center animate-fadeInFromUp will-change-transform gap-3">
    ...
    <section className="flex-col flex justify-center items-center md:flex-row lg:gap-2">
      ...
      <div className="text-justify flex flex-col gap-3 mb-5 text-sm md:text-base md:w-11/12 lg:gap-7 lg:w-9/12 lg:text-lg xl:text-xl">
        <p className="indent-8 animate-fadeInFromRight opacity-0">
          Hello Everyone! My name is Fariz Rifky Berliano, and I currently reside in Bekasi. For the past year, I have been immersed in web development, working with front-end, back-end, and full-stack technologies. I am passionate about
          programming because of the excitement of solving problems and creating impactful solutions.
        </p>
